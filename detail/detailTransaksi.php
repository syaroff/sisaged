...
<body>
    ...
    <div class="container container-fluid mt-5 mb-5">
      ...
      <div class="row mt-4">
          <?php
            $hasil = $konek->query("SELECT * FROM vwTransaksi WHERE id_transaksi = $_GET[i]");
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="card bg-white">
                                ...
                                <div class="card-body">
                                    <h5 class="text-primary"><?=$row['nama_gedung']?></h5>
                                    <h4 class="fw-bold">Rp. <?= number_format($row['total'],0,',','.');?></h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            ...
                            ?>
                                ...
                                <input type="date" name="tanggal_mulai" id="tanggalMulai" value="<?=$row['tanggal_mulai']?>" disabled class="form-control">
                                <h4 class="mt-3">Tanggal Selesai</h4>
                                <input type="date" name="tanggal_selesai" id="tanggalSelesai" value="<?=$row['tanggal_mulai']?>" disabled class="form-control">
                                <h4 class="mt-3">Metode Bayar</h4>
                                <input type="text" value="<?=$row['nama_metode']?>" class="form-control mt-2" disabled>
                                <input type="text" value="<?=$row['no_rekening']?>" class="form-control mt-2" disabled>
                                <p class="mt-2">Pastikan untuk membayar 50% Uang Muka,reservasi akan dimasukkan ke jadwal apabila sudah membayar 50% dari harga reservasi. <br><br><strong>JANGAN BUANG BUKTI TRANSFER KETIKA SUDAH SELESAI MENTRANSFER UANG KEPADA KAMI.</strong><br><br><strong>Sudah membayar?</strong> anda bisa menghubungi kami lewat Whatsapp dengan memberi bukti transfer,Klik tombol dibawah ini.</p>
